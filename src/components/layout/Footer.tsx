        ...
        <div className="bg-[#060A06] border border-[#182B18] rounded-3xl px-8 py-10 md:px-12 md:py-12 shadow-2xl">
          ...
          <div className="mt-16 pt-6 border-t border-[#182B18] flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <a href="#" aria-label="Instagram" className="text-[#728A72] hover:text-[#F5C842] transition-colors">
              ...
              <a href="#" aria-label="SoundCloud" className="text-[#728A72] hover:text-[#F5C842] transition-colors">
              ...
              <a href="#" aria-label="Beatport" className="text-[#728A72] hover:text-[#F5C842] transition-colors">
